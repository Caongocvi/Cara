      ...
      <div class="col-md-12">
        <div class="form-container">
          ...
          <form   action="index.php?action=dangnhap&act=dangnhap_action" class="form" method="post">
            ...
            <p class="page-link">
              <span class="page-link-label"><a class="sign-up-link" href="index.php?action=forget">Forgot Password?</a></span>
            </p>
            <button class="form-btn" type="submit">Log in</button>
          </form>
          <p class="sign-up-label">
            Don't have an account?<span class="sign-up-link"><a class="sign-up-link" href="index.php?action=dangky">Sign up</a></span>
          </p>
